          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                variants={reveal}
              >
                A secure, polished gateway for Willimedians to reach the
                internal tools they use every day.
              </motion.p>
          ...
          >
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
                Use the links below for the official iOS and Android apps, or
                scan the QR codes to open the store page instantly on your
                phone.
              </p>
            </div>

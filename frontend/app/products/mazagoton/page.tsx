...
const mazagotonProducts: MazagotonProductData[] = [
  {
    name: "Mazagoton - F",
    cardImage: "/images/Products/mazagoton/female_lady.png",
    popupImage: "/images/Products/mazagoton/female.png",
  ...
  },
  {
    ...
    cardImage: "/images/Products/mazagoton/energy_athlete.png",
    popupImage: "/images/Products/mazagoton/energy_new.png",
...
export default function MazagotonPage() {
  const [activeProduct, setActiveProduct] =
    useState<MazagotonProductData | null>(null);
          ...
          >
            <motion.div className="mt-10 text-center" variants={reveal}>
              <h2 className="text-3xl font-semibold tracking-normal text-slate-950 sm:text-4xl lg:text-5xl">
                Daily Wellness, Made <span className="font-black">Simpler</span>
              </h2>
              <div
                ref={heroRef}
              ...
              >
                ...
                >
                  <Image
                    ...
                    alt="Mazagoton Family illustration"
                    fill
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-7 text-slate-600 sm:text-base">
                ...
                busy schedule, focusing on your wellness goals, or maintaining
                an active lifestyle, our targeted formulas help provide the
            ...
            <motion.div className="mt-10 text-center" variants={reveal}>
              <h2 className="text-3xl font-semibold tracking-normal text-slate-950 sm:text-4xl lg:text-5xl">
                Nourish More, <span className="font-black">Live Better.</span>
              </h2>
            </motion.div>
            ...
            >
              <div className="grid gap-6 justify-items-center md:grid-cols-2 xl:grid-cols-3">
                {mazagotonProducts.map((product, index) => (
                  <motion.div
                    key={product.name}
                    className={`group relative h-[560px] w-full max-w-[380px] cursor-pointer overflow-hidden rounded-[32px] ${pastelColors[index]} shadow-lg`}
                    variants={reveal}
                    whileHover={{
                      scale: 1.05,
                      y: -12,
                  ...
                  >
                    ...
                    <div className="absolute inset-0">
                      <motion.div
                        className="absolute left-1/2 top-6 z-20 w-max max-w-[85%] -translate-x-1/2"
                        initial={{ opacity: 0, y: 10 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.15, duration: 0.5 }}
                        viewport={{ once: true }}
                      >
                        <div className="rounded-full bg-slate-900/50 px-4 py-2 text-center backdrop-blur-sm">
                      ...
                      <motion.button
                        type="button"
                        className="absolute bottom-6 right-6 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-slate-400/30 backdrop-blur-sm"
